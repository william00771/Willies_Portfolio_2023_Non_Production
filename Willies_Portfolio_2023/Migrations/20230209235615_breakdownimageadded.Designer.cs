...
namespace WilliesPortfolio2023.Migrations
{
    ...
    [Migration("20230209235615_breakdownimageadded")]
    partial class breakdownimageadded
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Willies_Portfolio_2023.Models.NetProjectBreakdownSection", b =>
                {
                    ...
                    b.Property<string>("BreakdownImage")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("BreakdownSecondaryImage")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
